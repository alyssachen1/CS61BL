...
public class DLListTest {
    ...
    public void testDLListReverse(){
        ...
        test1.reverse();
        assertWithMessage("testing 1 3 5").that(test1.equals(factory.of(5, 3, 1))).isTrue();
        DLList<Integer> test2 = factory.of(5);
        test2.reverse();
        assertWithMessage("testing 5").that(test2.equals(factory.of(5))).isTrue();
        DLList<Integer> test3 = factory.of();
        test3.reverse();
        assertWithMessage("testing").that(test3.equals(factory.of())).isTrue();
    }
}
