...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba> {
    ...
    public String longestName() {
        ...
        return root.longestNameHelper(root, root.name);
    }
    ...
    public static class Amoeba {
        ...
        public String longestNameHelper(Amoeba curr, String maxLength) {
            if (curr.name.length() > maxLength.length()) {
                maxLength = curr.name;
            }
            for (Amoeba a : curr.children) {
                String childMaxLength = longestNameHelper(a, maxLength);
                if (childMaxLength.length() > maxLength.length()) {
